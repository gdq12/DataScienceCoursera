This is the exact instructions provided by the instructor for this project which was completed in December 2019. [Original Rpubs submission](https://rpubs.com/gdquiceno/556761)
...
The data for this assignment come in the form of a comma-separated-value file compressed via the bzip2 algorithm to reduce its size. You can download the file from the course web site: [zip file](https://d396qusza40orc.cloudfront.net/repdata%2Fdata%2FStormData.csv.bz2)
